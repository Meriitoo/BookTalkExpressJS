...
router.post('/register', isGuest, async (req, res) => {
    const { email, username, password, repeatPassword} = req.body; //from register.hbs name property in html
    ...
    try{
        ...
        res.status(400).render('auth/register', {email, username, password, error: getErrorMessage(error)})
    }
});
